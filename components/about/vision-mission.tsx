      ...
      <Container className="space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <FadeIn direction="right">
            <Card hoverable className="h-full bg-ccf-surface border-ccf-gold/30 p-8 flex flex-col justify-between space-y-6">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {ABOUT_VISION_MISSION.objectives.map((obj, idx) => (
              <StaggerItem key={obj.id}>
                <Card hoverable className="h-full bg-ccf-surface/70 border-border/40 p-6 space-y-4">
